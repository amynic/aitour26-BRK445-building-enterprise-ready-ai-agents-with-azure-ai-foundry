...
This is a sample of the steps of the generation process.

- Confirmation to delete existing agents
![Confirmation to delete existing agents if they already exist](./imgs/07-ConfirnAgentDeletion.png)

- Console Output with the creation progress completed
![Console Output with the creation progress completed](./imgs/08-AgentDeploymentComplete.png)

- Agent deployed to the Microsoft Foundry resource
![Model deployments screenshot](./imgs/11-agentsdeployed.png)



## 5) Create an Application Insights resource in Azure
...
![Resource Group with Application Insights and Microsoft Foundry resources](./imgs/20-ResourceGroupWithAppInsAndFoundry)
