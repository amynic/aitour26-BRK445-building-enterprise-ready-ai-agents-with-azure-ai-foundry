...
- Recommended models: `gpt-5.1-mini` a
...
1. For the demo we need 2 models
    ...
    1. Optional. For the semantic search demo also need an embedding model: `text-embedding-3-small`
...
dotnet user-secrets set "ModelDeploymentName" "gpt-5.1-mini"
